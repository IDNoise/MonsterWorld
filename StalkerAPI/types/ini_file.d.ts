...
declare class ini_file {
    ...
    line_count(section: Section): number;
    ...
    r_line(section: Section, index: number, arg1?: string, arg2?: string): LuaMultiReturn<[boolean, string, string | number | any]>;
    r_line_ex(section: Section, index: number): LuaMultiReturn<[boolean, string, string | number | any]>;
