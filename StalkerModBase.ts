...
export class StalkerModBase {
    ...
    GetMCMConfig(): MCMMainGroup{
        return {id: StalkerModBase.ModName, gr: [

        ]};
    }
}

export type MCMMainGroup = {
    id: string, //Mod name
    gr: MCMSubGroup[],
}

export type MCMSubGroup ={
    id: string, //Group name
    sh: boolean, //used to detemine that the sub-tree tables are actual list of options to set and show
    gr: MCMElement[]
}

export type MCMElement = MCMFieldConfigLine 

export const enum MCMElementType {

}

export type MCMElementBase = {
    id: string, // field id
    type: MCMElementType, 
}

export type MCMOptionElement = {

} & MCMElementBase

export type MCMSupportElement = {

} & MCMElementBase

export type MCMFieldConfigLine = {
